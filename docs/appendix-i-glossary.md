...
and the chip pages ([Part I](part-1-foundations.md), [Part III](part-3-vic.md),
[Part IV](part-4-sid.md), [Part III](part-3-vic.md),
[Part VI](part-6-game.md)).
...
[Part IV](part-4-sid.md), Appendix D.
...
scrolling bitmap games. See [Part III](part-3-vic.md).
...
*text/char mode*. See [Part III](part-3-vic.md), Appendix C.
...
(multicolor bitmap). See Appendix B/C, [Part III](part-3-vic.md).
...
TOD clock, and a shift register. See Appendix E, [Part I](part-1-foundations.md).
...
combines this with opened borders. See [Part III](part-3-vic.md).
...
See [Part III](part-3-vic.md), Appendix H.
...
"FLI bug" artifact and requires a stable raster. See [Part III](part-3-vic.md).
...
(`SHX/SHY/SHA/TAS`) are unstable. See Appendix A, [Part I](part-1-foundations.md).
...
B/E, [Part I](part-1-foundations.md).
...
though the IRQ itself fires ~50 Hz on PAL. See [Part I](part-1-foundations.md).
...
See [Part III](part-3-vic.md), [Part VI](part-6-game.md).
...
of sprite-heavy games and "100 sprites" demos. See [Part VI](part-6-game.md).
...
Appendix H, [Part I](part-1-foundations.md).
...
emits `.prg` and a matching VICE symbol/label file. See [Toolchain](toolchain.md).
...
effect. See *stable raster*, [Part III](part-3-vic.md), Appendix C/H.
...
sprite-stretch bars. See *MOB/sprite*, [Part III](part-3-vic.md).
...
[Part III](part-3-vic.md), Appendix H.
...
[Part III](part-3-vic.md), Appendix C/E.
